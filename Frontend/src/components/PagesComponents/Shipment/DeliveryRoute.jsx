                  ...
                  <ul className="shipments_list_ul">
                    {shipments.map((shipment) => (
                      <li key={shipment.id_shipment} className="shipment">
                        ...
                        <h3>Destinatario</h3>
                        <p>
                          <strong>Nombre: </strong> {shipment.customer_name}
                        </p>
                        <p>
                          <strong>Compañía: </strong> {shipment.company_name}
                        </p>
                        <p>
                        ...
                        <p>
                          <strong>Producto: </strong> {shipment.product_name}
                        </p>
                        <p>
                        ...
                        <p>
                          <strong>Ciudad: </strong> {shipment.address_city}
                        </p>
                        <p>
                          <strong>Teléfono: </strong> {shipment.customer_phone}
                        </p>
